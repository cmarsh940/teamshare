...
class CreatePostForm extends StatefulWidget {
  ...
  const CreatePostForm({super.key, required this.teamId, required this.userId});
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: SafeArea(
          child: Padding(
            ...
            child: Builder(
              // <-- get inner context inside BlocProvider
              builder:
                  (innerContext) => SizedBox(
                    width: double.infinity,
                    height: 48,
                    child: ElevatedButton(
                      onPressed: () {
                        if (_formKey.currentState!.validate()) {
                          ...
                          innerContext.read<PostBloc>().add(
